...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      {/* Mobile header */}
      <div className="md:hidden flex justify-between items-center bg-white p-4 h-16">
        ...
        <button onClick={toggleSidebar} className="w-8 h-8 flex items-center justify-center">
